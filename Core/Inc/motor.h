...
// 制动参数
#define BRAKE_PULSE_SPEED   150         // 一级反向制动速度
#define BRAKE_PULSE_MS      25          // 一级反向制动时间(ms)
#define BRAKE_HOLD_SPEED    150         // 二级反向拖刹速度
#define BRAKE_HOLD_MS       0           // 二级反向拖刹时间(ms)
...
// 斜坡平滑参数
#define RAMP_STEP           350         // 每10ms最大PWM变化量
