...
#define FIGHT_RETREAT_SPEED 500
#define FIGHT_EDGE_RETREAT_DIFF 100
#define FIGHT_TURN_TIME   550 //掉头时间(180°)
#define FIGHT_EDGE_TURN_TIME 320
#define FIGHT_EDGE_ARC_MEMORY_MS 800U
...
#define FIGHT_TRACK_FRONT_ARC_INNER_SPEED 0//前侧方甩头内侧轮速度
#define FIGHT_TRACK_FRONT_ARC_OUTER_SPEED 550 //前侧方甩头外侧轮速度
#define FIGHT_TRACK_FRONT_SMALL_ARC_INNER_SPEED 375 //前方小弧线内侧轮速度
#define FIGHT_TRACK_FRONT_SMALL_ARC_OUTER_SPEED 550 //前方小弧线外侧轮速度
#define FIGHT_TRACK_PUSH_SPEED 480 //正前推进速度
#define FIGHT_TRACK_SIDE_ARC_BACK_SPEED 100 //正侧方甩头内侧反转速度
#define FIGHT_TRACK_SIDE_ARC_FORWARD_SPEED 550 //正侧方甩头外侧前进速度
#define FIGHT_TRACK_REAR_ARC_BACK_SPEED 100 //后侧方甩头内侧反转速度
#define FIGHT_TRACK_REAR_ARC_FORWARD_SPEED 650 //后侧方甩头外侧前进速度
#define FIGHT_FRONT_ARC_HOLD_MS 100U
#define FIGHT_FRONT_CONFIRM_COUNT 3
