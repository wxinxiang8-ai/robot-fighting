...
#define FIGHT_EDGE_ARC_BACK_TIME 1000
#define FIGHT_EDGE_ARC_BACK_STRONG_SPEED 500
#define FIGHT_EDGE_ARC_BACK_WEAK_SPEED 250
#define FIGHT_TURN_TIME   550 //掉头时间(180°)
#define FIGHT_EDGE_ARC_TURN_TIME 320
...
#define FIGHT_TRACK_FRONT_ARC_INNER_SPEED -400 //前侧方弧线内侧轮速度
#define FIGHT_TRACK_FRONT_ARC_OUTER_SPEED 500 //前侧方弧线外侧轮速度
...
#define FIGHT_TRACK_REAR_ARC_BACK_SPEED 300 //后侧方急转内侧反转速度
#define FIGHT_TRACK_REAR_ARC_FORWARD_SPEED 650 //后侧方急转外侧前进速度
